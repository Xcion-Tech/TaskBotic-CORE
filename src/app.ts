...
export class App {
  ...
  middlewares() {
    ...
    var corsOptions = {
      ...
      exposedHeaders: ['Bearer-Token', 'Set-Cookie', 'Content-Type', 'ETag', 'Date', 'Connection']
    }
  ...
  async listen() {
    ...
    console.info(`Initializing TaskBotic Microservices Complete. Server is running on port:${this.app.get("port")}`);
